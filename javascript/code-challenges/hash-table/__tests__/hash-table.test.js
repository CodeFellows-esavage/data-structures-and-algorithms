...
describe('Testing Hashtable Class', () => {
  it('should store a key/value in the data structure', () => {
  ...
  it('should retreive a value based on the key', () => {
  ...
  it('should beable to return a list of all unique keys in the table', () => {
    let ht = new HashTable(5);
    ht.set('key1', 'value1');
    ht.set('key1', 'value1');
    ht.set('key2', 'value2');
  ...
  it('should beable to return a list of all unique values in the table', () => {
    let ht = new HashTable(5);
    ht.set('key1', 'value1');
    ht.set('key1', 'value1');
    ht.set('key2', 'value2');
