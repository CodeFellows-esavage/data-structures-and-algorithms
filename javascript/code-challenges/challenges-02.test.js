...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let newArray = arr.map(arrayNumber => Math.pow(arrayNumber, 3));
  return newArray;
};
...
const addOne = (arr) => {
  // Solution code here...
  let newArray = arr.map(arrNum => arrNum + 1);
  return newArray;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let newArray = [];
  arr.forEach(arrNum => newArray.push(Math.pow(2, arrNum)));
  return newArray;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let newArray = arr.map(arrNum => Math.pow(2, arrNum));
  return newArray;
};
...
const charCode = (arr) => {
  // Solution code here...
  let newArray = arr.map(arrStr => arrStr.charCodeAt());
  return newArray;
};
...
const extractAbilities = (arr) => {
  // Solution code here...
  let abilityNames = arr.map(abilitySlot => abilitySlot.ability.name);
  return abilityNames;
};
