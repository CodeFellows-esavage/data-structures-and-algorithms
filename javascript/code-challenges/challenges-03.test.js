...
const typeNum = (arr) => {
  // Solution code here...
  let numArr = arr.filter(arrVal => (typeof(arrVal) === 'number'));
  return numArr;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let oddValues = arr.filter(arrNum => (arrNum % 2));
  return oddValues;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let notInFirstArray = arr.filter(arrNum => !(forbiddenValues.includes(arrNum)));
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let greaterStat = arr.filter(arrObj => (arrObj.baseStat > minBaseStat));
  return greaterStat;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let greaterStat = arr.filter(arrObj => (arrObj.baseStat > minBaseStat));
  let greaterStatName = greaterStat.map(arrObj => arrObj.stat.name);
  return greaterStatName;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  const noChilderen = arr.filter(arrObj => !(arrObj.children));
  return noChilderen;
};
