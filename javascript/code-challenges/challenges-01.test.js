...
const addOne = (arr) => {
  // Solution code here...
  let localArray = [];
  arr.forEach(arrayNumber => localArray.push(arrayNumber + 1));
  return localArray;
};
...
const addExclamation = (arr) => {
  // Solution code here...
  let localArray = [];
  arr.forEach(arrayString => localArray.push(`${arrayString}!`));
  return localArray;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let localArray = [];
  arr.forEach(arrayString => localArray.push(arrayString.toUpperCase()));
  return localArray;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  let newArray = [];
  words.forEach(arrayWord => newArray.push(callback(arrayWord)));
  return newArray;
};
...
const createList = (availableItems) => {
  // Solution code here...
  let groceryList = [];
  availableItems.forEach(inventoryItem => (inventoryItem.available) ? groceryList.push(inventoryItem.name) : console.log(`${inventoryItem.name} is out of stock`));
  return groceryList;
};
...
const fizzbuzz = (arr) => {
  // Solution code here...
  //https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Remainder for reference on remainder operand
  let outputArray = [];
