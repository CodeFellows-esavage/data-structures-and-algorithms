...
describe('Testing the depthFirst method for graph', () => {
  ...
  it('should an array containing a single vertex on a graph with one vertex', () => {
    let test = new Graph;
    test.addVertex('Z');
    let result = test.depthFirst('Z');
    expect(result).toEqual(['Z']);
  });
  it('should an array in the preorder traversal order for the example test case graph', () => {
