...
const toLastNames = people => {
  // Solution code here...
  return people.map(pplObj => `${pplObj.firstName} ${pplObj.lastName}`);
};
...
const calculateAverage = (arr) => {
  // Solution code here...
  const avgObj = arr.reduce((tracker, crtNum) => {
    tracker.sum = tracker.sum + crtNum;
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  return arr.reduce((primeCount, currentNum) =>{
