...
describe('Testing the insertionSort Function', () => {
  it('should reverse the example array', () => {
  ...
  it('should reverse a reverse sorted array', () => {
  ...
  it('should reverse a few uniques array', () => {
  ...
  it('should reverse a nearly-sorted array', () => {
